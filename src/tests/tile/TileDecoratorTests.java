...
public class TileDecoratorTests {
	...
	public void extraDefensesDecoratorTests() {
		MutableTile tile = new ExtraDefensesDecorator(new DefaultTile(0, 0, 100, 100));
	...
	public void efficientExtractionDecoratorTests() {
		MutableTile tile = new EfficientExtractionDecorator(new DefaultTile(0, 0, 100, 100));
	...
	public void stealthyDecoratorTests() {
		MutableTile tile = new StealthyDecorator(new DefaultTile(0, 0, 100, 100));
