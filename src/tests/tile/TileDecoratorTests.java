...
public class TileDecoratorTests {
	...
	public void extraDefensesDecoratorTests() {
		MutableTile tile = new ExtraDefensesDecorator(new DefaultTile.Builder().setRequired(100, 100).build(0, 0));
	...
	public void efficientExtractionDecoratorTests() {
		MutableTile tile = new EfficientExtractionDecorator(new DefaultTile.Builder().setRequired(100, 100).build(0, 0));
	...
	public void stealthyDecoratorTests() {
		MutableTile tile = new StealthyDecorator(new DefaultTile.Builder().setRequired( 100, 100).build(0, 0));
